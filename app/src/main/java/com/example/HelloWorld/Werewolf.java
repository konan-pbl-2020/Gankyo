...
public class Werewolf extends AppCompatActivity {
    ...
    void setScreenMain(){
        ...
        //画像セット
        if(position[0] == WOLF) img1.setImageResource(R.drawable.wolf_2);
        else if(position[0] == DIVINER) img1.setImageResource(R.drawable.diviner);
        else if(position[0] == THIEF) img1.setImageResource(R.drawable.thief_2);
        else if(position[0] == TERU) img1.setImageResource(R.drawable.teruteru_2);
        else if(position[0] == VILLAGER) img1.setImageResource(R.drawable.villager_2);
        if(position[1] == WOLF) img2.setImageResource(R.drawable.wolf_2);
        else if(position[1] == DIVINER) img2.setImageResource(R.drawable.diviner);
        else if(position[1] == THIEF) img2.setImageResource(R.drawable.thief_2);
        else if(position[1] == TERU) img2.setImageResource(R.drawable.teruteru_2);
        else if(position[1] == VILLAGER) img2.setImageResource(R.drawable.villager_2);
        if(position[2] == WOLF) img3.setImageResource(R.drawable.wolf_2);
        else if(position[2] == DIVINER) img3.setImageResource(R.drawable.diviner);
        else if(position[2] == THIEF) img3.setImageResource(R.drawable.thief_2);
        else if(position[2] == TERU) img3.setImageResource(R.drawable.teruteru_2);
        else if(position[2] == VILLAGER) img3.setImageResource(R.drawable.villager_2);
        if(position[3] == WOLF) img4.setImageResource(R.drawable.wolf_2);
        else if(position[3] == DIVINER) img4.setImageResource(R.drawable.diviner);
        else if(position[3] == THIEF) img4.setImageResource(R.drawable.thief_2);
        else if(position[3] == TERU) img4.setImageResource(R.drawable.teruteru_2);
        else if(position[3] == VILLAGER) img4.setImageResource(R.drawable.villager_2);
        if(position[4] == WOLF) img5.setImageResource(R.drawable.wolf_2);
        else if(position[4] == DIVINER) img5.setImageResource(R.drawable.diviner);
        else if(position[4] == THIEF) img5.setImageResource(R.drawable.thief_2);
        else if(position[4] == TERU) img5.setImageResource(R.drawable.teruteru_2);
        else if(position[4] == VILLAGER) img5.setImageResource(R.drawable.villager_2);
        if(peopleNum<4) img6.setVisibility(View.INVISIBLE);
        if(position[5] == WOLF) img6.setImageResource(R.drawable.wolf_2);
        else if(position[5] == DIVINER) img6.setImageResource(R.drawable.diviner);
        else if(position[5] == THIEF) img6.setImageResource(R.drawable.thief_2);
        else if(position[5] == TERU) img6.setImageResource(R.drawable.teruteru_2);
        else if(position[5] == VILLAGER) img6.setImageResource(R.drawable.villager_2);
        if(peopleNum<5) img7.setVisibility(View.INVISIBLE);
        if(position[6] == WOLF) img7.setImageResource(R.drawable.wolf_2);
        else if(position[6] == DIVINER) img7.setImageResource(R.drawable.diviner);
        else if(position[6] == THIEF) img7.setImageResource(R.drawable.thief_2);
        else if(position[6] == TERU) img7.setImageResource(R.drawable.teruteru_2);
        else if(position[6] == VILLAGER) img7.setImageResource(R.drawable.villager_2);
        if(peopleNum<6) img8.setVisibility(View.INVISIBLE);
        if(position[7] == WOLF) img8.setImageResource(R.drawable.wolf_2);
        else if(position[7] == DIVINER) img8.setImageResource(R.drawable.diviner);
        else if(position[7] == THIEF) img8.setImageResource(R.drawable.thief_2);
        else if(position[7] == TERU) img8.setImageResource(R.drawable.teruteru_2);
        else if(position[7] == VILLAGER) img8.setImageResource(R.drawable.villager_2);
        if(peopleNum<7) img9.setVisibility(View.INVISIBLE);
        if(position[8] == WOLF) img9.setImageResource(R.drawable.wolf_2);
        else if(position[8] == DIVINER) img9.setImageResource(R.drawable.diviner);
        else if(position[8] == THIEF) img9.setImageResource(R.drawable.thief_2);
        else if(position[8] == TERU) img9.setImageResource(R.drawable.teruteru_2);
        else if(position[8] == VILLAGER) img9.setImageResource(R.drawable.villager_2);
        if(peopleNum<8) img10.setVisibility(View.INVISIBLE);
        if(position[9] == WOLF) img10.setImageResource(R.drawable.wolf_2);
        else if(position[9] == DIVINER) img10.setImageResource(R.drawable.diviner);
        else if(position[9] == THIEF) img10.setImageResource(R.drawable.thief_2);
        else if(position[9] == TERU) img10.setImageResource(R.drawable.teruteru_2);
        else if(position[9] == VILLAGER) img10.setImageResource(R.drawable.villager_2);
        if(peopleNum<9) img11.setVisibility(View.INVISIBLE);
        if(position[10] == WOLF) img11.setImageResource(R.drawable.wolf_2);
        else if(position[10] == DIVINER) img11.setImageResource(R.drawable.diviner);
        else if(position[10] == THIEF) img11.setImageResource(R.drawable.thief_2);
        else if(position[10] == TERU) img11.setImageResource(R.drawable.teruteru_2);
        else if(position[10] == VILLAGER) img11.setImageResource(R.drawable.villager_2);
        if(peopleNum<10) img12.setVisibility(View.INVISIBLE);
        if(position[11] == WOLF) img12.setImageResource(R.drawable.wolf_2);
        else if(position[11] == DIVINER) img12.setImageResource(R.drawable.diviner);
        else if(position[11] == THIEF) img12.setImageResource(R.drawable.thief_2);
        else if(position[11] == TERU) img12.setImageResource(R.drawable.teruteru_2);
        else if(position[11] == VILLAGER) img12.setImageResource(R.drawable.villager_2);
    ...
    void position(final int i){ //役職確認画面
        ...
        if(position[i] == WOLF){
            poN.setText("人狼");
            positionImage.setImageResource(R.drawable.wolf_2);
        }else if(position[i] == DIVINER){
            poN.setText("占い師");
            positionImage.setImageResource(R.drawable.diviner);
        }else if(position[i] == THIEF){
            poN.setText("怪盗");
            positionImage.setImageResource(R.drawable.thief_2);
        }else if(position[i] == TERU){
            poN.setText("てるてる");
            positionImage.setImageResource(R.drawable.teruteru_2);
        }else{
            poN.setText("村人");
            positionImage.setImageResource(R.drawable.villager_2);
        }
